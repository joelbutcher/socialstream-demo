...
You should now be able to visit the site at [`https://laravel.test`](https://laravel.test)
...
You will then need to create a database called `laravel`, if it doesn't already exist.
