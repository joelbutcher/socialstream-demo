...
const classes = computed(() => {
    return props.active
        ...
        : 'block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-slate-600 hover:text-slate-800 hover:bg-gray-50 hover:border-zinc-300 focus:outline-none focus:text-slate-800 focus:bg-gray-50 focus:border-zinc-300 transition';
});
</script>
