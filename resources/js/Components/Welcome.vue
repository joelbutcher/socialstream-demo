...
<template>
  <div class="dark:bg-slate-700">
    <div class="p-6 sm:px-20 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-800">
      <div>
        <JetApplicationLogo class="block h-12 w-auto" />
      </div>

      <div class="mt-8 text-2xl dark:text-slate-200">
        Welcome to your Jetstream application!
      </div>

      <div class="mt-6 text-slate-500 dark:text-slate-400">
    ...
    <div class="bg-gray-200/25 dark:bg-slate-900/25 grid grid-cols-1 md:grid-cols-2">
      <div class="p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4 text-lg text-slate-600 dark:text-slate-300 leading-7 font-semibold">
        ...
        <div class="ml-12">
          ...
          <a href="https://laravel.com/docs">
            <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700 dark:text-indigo-400">
              ...
              <div class="ml-1 text-indigo-500 dark:text-indigo-500">
      ...
      <div class="p-6 border-t border-slate-200 dark:border-slate-800 md:border-t-0 md:border-l">
        <div class="flex items-center">
          <svg
              fill="none"
              stroke="currentColor"
      ...
      <div class="p-6 border-t border-slate-200 dark:border-slate-800 md:border-l">
        <div class="flex items-center">
          <svg
              fill="none"
              stroke="currentColor"
