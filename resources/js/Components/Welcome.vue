...
<template>
  <div class="dark:bg-slate-700">
    <div class="p-6 md:px-20 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-800">
      <div>
    ...
    <div class="bg-gray-200/25 dark:bg-slate-900/25 grid grid-cols-1 md:grid-cols-2">
      <div class="p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4 text-lg text-slate-600 dark:text-slate-400 leading-7 font-semibold">
