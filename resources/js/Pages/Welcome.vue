...
<template>
  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    <div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
      <Link v-if="$page.props.user" :href="route('dashboard')" class="text-sm text-slate-700 dark:text-slate-500 underline">Dashboard</Link>

      <template v-else>
        <Link :href="route('login')" class="text-sm text-slate-700 dark:text-slate-500 underline">Log in</Link>

        <Link v-if="canRegister" :href="route('register')" class="ml-4 text-sm text-slate-700 dark:text-slate-500 underline">Register</Link>
      </template>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg leading-7 font-semibold">
                <a href="https://laravel.com/docs" class="underline text-slate-900 dark:text-white">Documentation</a>
              </div>
            </div>
          ...
          <div class="p-6 border-t border-slate-200 dark:border-slate-700 md:border-t-0 md:border-l">
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg leading-7 font-semibold">
                <a href="https://laracasts.com" class="underline text-slate-900 dark:text-white">Laracasts</a>
              </div>
            </div>
          ...
          <div class="p-6 border-t border-slate-200 dark:border-slate-700">
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg leading-7 font-semibold">
                <a href="https://laravel-news.com/" class="underline text-slate-900 dark:text-white">Laravel News</a>
              </div>
            </div>
          ...
          <div class="p-6 border-t border-slate-200 dark:border-slate-700 md:border-l">
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg leading-7 font-semibold text-slate-900 dark:text-white">
                Vibrant Ecosystem
              </div>
            </div>
