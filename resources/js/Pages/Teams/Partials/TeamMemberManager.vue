                    ...
                    <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
                        ...
                        <div class="relative z-0 mt-1 border border-zinc-200 rounded-lg cursor-pointer">
                            <button
                                ...
                                :class="{'border-t border-zinc-200 rounded-t-none': i > 0, 'rounded-b-none': i != Object.keys(availableRoles).length - 1}"
                                @click="addTeamMemberForm.role = role.key"
                            >
                                <div :class="{'opacity-50': addTeamMemberForm.role && addTeamMemberForm.role != role.key}">
                                    <!-- Role Name -->
                                    <div class="flex items-center">
                                        <div class="text-sm text-slate-800 dark:text-slate-200 font-semibold" :class="{'font-semibold': addTeamMemberForm.role == role.key}">
                                            {{ role.name }}
                                        </div>
                        ...
                        <div v-for="user in team.users" :key="user.id" class="flex items-center justify-between">
                            ...
                            <div class="flex items-center">
                                ...
                                <button
                                    ...
                                    class="ml-2 text-sm text-slate-400 underline"
                    ...
                    <div class="relative z-0 mt-1 border border-zinc-200 rounded-lg cursor-pointer">
                        ...
                        >
                            <div :class="{'opacity-50': updateRoleForm.role && updateRoleForm.role !== role.key}">
                                <!-- Role Name -->
                                <div class="flex items-center">
                                    <div class="text-sm text-slate-600" :class="{'font-semibold': updateRoleForm.role === role.key}">
                                        {{ role.name }}
                                    </div>
